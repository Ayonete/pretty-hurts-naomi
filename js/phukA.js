...
let model;
loader.load('https://cors-anywhere.herokuapp.com/https://github.com/mxmadu/pretty-hurts/releases/download/untagged-31a0411e97bafbfb3bba/PHUK_PHACE_A.glb',
 function(gltf) {
  model = gltf.scene;
  ...
  scene.add(model);
    ...
    window.touchpoints = [
      {
          ...
          images: [
              { src: 'https://mxmadu.github.io/pretty-hurts/img/blackbeard.jpeg', alt: 'Blackbeard from One Piece grinning nefariously, tan skin, large nose, missing upper and lower teeth', caption: '&lt;Blackbeard_in_one_piece&gt;' },
              { src: 'https://mxmadu.github.io/pretty-hurts/img/captain_hook.jpeg', alt: 'Captain Hook in Peter Pan with a red coat and massive, deep purple hat. He left hand is a golden hook and he has a large nose and pointy mustache, he is grinning mischeviously', caption: '&lt;Captain_hook_in_peter_pan&gt;' }
          ],
          footer: '',
      },
      {
          ...
          images: [
              { src: 'https://mxmadu.github.io/pretty-hurts/img/rogers.jpg', alt: 'Woodes Rogers from Assassin\'s Creed, short brown hair a huge scar all over his left cheek,', caption: '&lt;Woodes_rogers_in_assassin\'s_creed&gt;' },
              { src: 'https://mxmadu.github.io/pretty-hurts/img/silco.jpeg', alt: 'Silco in Arcane, short black hair, a long narrow face and nose, one green eye and one prosthetic eye as well as 3 long scars going from his left temple to his upper lip', caption: '&lt;Silco_in_arcane_&gt;' }
          ],
          footer: '',
      },
      {
        ...
        images: [
            { src: 'https://mxmadu.github.io/pretty-hurts/img/voldemort.jpg', alt: 'Voldemort, from the Harry Potter Franchise, bald and extremely pale, holding a wand menancingly', caption: '&lt;VOLDEMORT_IN_the_HARRY_POTTER_movies&gt;' },
            { src: 'https://mxmadu.github.io/pretty-hurts/img/twins.png', alt: 'The twins from The Matrix Reloaded with albinism, sitting in a car',caption: '&lt;The_twins_from_the_matrix_reloaded&gt;' }
        ],
        footer: '',
    },
      {
        ...
        images: [
            { src: 'https://mxmadu.github.io/pretty-hurts/img/eggman.jpeg', alt: 'Dr. Eggman, bald and round, wears a red coat and black pants that blend into boots', caption: '&lt;Dr._Eggman_in_sonic_the_hedgehog&gt;' },
            { src: 'https://mxmadu.github.io/pretty-hurts/img/scott_evil.jpeg', alt: 'Scott Evil in Austin Powers, balding in the front but with spiky hair all over', caption: '&lt;Scott_Evil_in_Austin_Powers&gt;*' }
        ],
    ...
    },
    {
      ...
      images: [
          { src: 'https://mxmadu.github.io/pretty-hurts/img/moira.jpeg', alt: 'Moira from Overwatch, a red-head with a long, angular face', caption: '&lt;Moira_in_overwatch&gt;' },
          { src: 'https://mxmadu.github.io/pretty-hurts/img/rasputin.jpg', alt: 'Rasputin in Anastasia, long narrow face, dark hair and is depicted with some green smoke/light swirling around his head', caption: '&lt;rasputin_in_anastasia&gt;' }
      ],
      footer:'',
  },
  {
    ...
    images: [
        { src: 'https://mxmadu.github.io/pretty-hurts/img/kriplespac.jpeg', alt: 'Professor Von Kriplespac, from Conker\'s Bad Fur Day, a rodent-like creature with a robotic arm and mechanical eye sitting in a jet-powered, joy-stick-controlled chair', caption: '&lt;Professor_von_kriplespac_in_conker\'s_bad_fur_day&gt;'},
        { src: 'https://mxmadu.github.io/pretty-hurts/img/aemond.jpg', alt: 'Aemond Targaryen from House of The Dragon, long blonde hair, long face and a scar down his left eye covered by an eye patch', caption: '&lt;Aemond_Targaryen_in_house_of_the_Dragon&gt;' }
    ],
    footer: '',
